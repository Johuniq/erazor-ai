    ...
    <section id='use-cases' className='py-24'>
      ...
      <div className="mx-auto max-w-2xl text-center">
        <span className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary my-4">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Perfect for every industry</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            See how professionals across industries use Erazor AI to streamline their workflow.
          </p>
        </div>
