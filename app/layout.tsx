...
export const metadata: Metadata = {
  title: {
    default:
      "AI Image Editor - Remove Background & Upscale Images Online Free | Erazor AI",
    template: "%s | Erazor AI - AI Image Editing Tools",
  },
  description:
    "Free AI image editor to remove background from images instantly and upscale photos up to 4x resolution. Professional background remover & image upscaler online. No signup required for first 3 images. Trusted by 100K+ users worldwide.",
  keywords: [
    "ai image editor",
    "ai image editing",
    "remove background",
